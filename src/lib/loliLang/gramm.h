...
namespace loli {
    struct IGrammarChecker {
        ...
        virtual void TryFindTokenWithFormaOrThrow (size_t start, loli::Forma forma, const std::string& message) = 0;
    };
    ...
    struct DefGrammarChecker : public IGrammarChecker {
        ...
        void TryFindTokenWithFormaOrThrow (size_t start, loli::Forma forma, const std::string& message) override;
